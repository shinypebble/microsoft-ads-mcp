...
_INSTRUCTIONS = (
    ...
    "`get_ads` returns the RSA copy (headlines/descriptions/paths). Every level reports its "
    ...
    "goals and UET tags (`get_conversion_goals` / "
    ...
    "presence vs. search-interest targeting), and the Bulk API (`bulk_download` / "
    "`bulk_upload`).\n"
